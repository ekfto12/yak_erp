         ...
         <div class="main-content">
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3 col-lg-3 " align="center"> <img width="80%;"style="margin-top: 20px;" alt="User Picture" src="resources/img/default_user.png" class="img-circle img-responsive"> </div>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <div class="row">
 			<div class="col-md-3 col-lg-3 " align="center"> <img width="80%;" style="margin-top: 30px;"alt="User Picture" src="resources/img/default_user.png" class="img-circle img-responsive"> </div>
                <div class=" col-md- col-lg-5 "> 
                  <table class="table table-user-information">
                    <tbody>
                      <tr>
