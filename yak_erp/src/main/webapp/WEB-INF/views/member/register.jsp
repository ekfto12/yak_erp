...
<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="" class="active"><i class="lnr lnr-home"></i> <span>ERP프로젝트</span></a></li>
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
<<<<<<< HEAD:yak_erp/src/main/webapp/WEB-INF/views/register.jsp
...
>>>>>>> c4d266d2a62279a024472eb8266d8a5db6e66c54:yak_erp/src/main/webapp/WEB-INF/views/member/register.jsp
								</ul>
							</div>
						</li>
					...
					<div class="col-md-8"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">기업 회원 정보 등록</h3>
							</div>
