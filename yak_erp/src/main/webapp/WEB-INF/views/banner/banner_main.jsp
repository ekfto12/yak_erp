...
<<<<<<< HEAD:yak_erp/src/main/webapp/WEB-INF/views/banner_main.jsp
									<li><a href="/yak_erp/Banner" class="active">배너관리</a></li>
=======
									<li><a href="/yak_erp/Banner?num=1" class="active">배너관리</a></li>
>>>>>>> c4d266d2a62279a024472eb8266d8a5db6e66c54:yak_erp/src/main/webapp/WEB-INF/views/banner/banner_main.jsp
