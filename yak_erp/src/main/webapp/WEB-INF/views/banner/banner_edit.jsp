								...
								<div class="row">
									...
									<form class="form-auth-small" action="bannerup" method="post" enctype="multipart/form-data">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="${banner.company_name}" name="company_name" id="company_name"size="10px" placeholder="" />

										</div>

										<div class="form-group">
											<p style="padding-left: 10px">배너 등록일</p>
											<input class="form-control" type="date" value="${banner.ban_start}" name="ban_start" id="ban_start" placeholder="생년월일" />

										</div>
										<div class="form-group">
											<p style="padding-left: 10px">배너 종료일</p>
											<input class="form-control" type="date" value="${banner.ban_exit}" name="ban_exit" id="ban_exit"placeholder="생년월일" />
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" value="${banner.price}" name="price" id="price"size="10px" placeholder="" />
