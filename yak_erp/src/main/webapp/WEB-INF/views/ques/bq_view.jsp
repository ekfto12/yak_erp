		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">기업 회원 문의 조회</h3>
					...
					<div class="col-md-8"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">기업 회원 문의 조회</h3>
							</div>
							...
							<form method="post" >
								<div class="row">
									...
									<div class=" col-md- col-lg-12 ">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>제목:</td>
													<td><input type="text" class="form-control" id="subject" name="subject" placeholder="제목" value="${bq_view.subject}" onfocus="javascrpt:blur();" style="cursor:default"></td>
													<tr>
													<td>기업명:
													<td><input type="text" class="form-control" id="company_name" name="company_name" placeholder="기업명" value="${bq_view.company_name}" onfocus="javascrpt:blur();"style="cursor:default"></td>
													</tr>
							
													<tr>
													<td>내용:</td>
													<td><textarea class="form-control" id="question" name="question" placeholder="문의내용" rows="4" onfocus="javascrpt:blur();" style="cursor:default">${bq_view.question} </textarea></td>
									...
									<button type="submit" class="btn btn-default"
										...
										<p align=right>
										<a href="/yak_erp/bq_status?bqno=${bq_view.bqno}">처리완료</a> &emsp;
										<a href="/yak_erp/b_quesList?num=1" align:left;>리스트로</a> &emsp;
										<a href="/yak_erp/bq_modify?bqno=${bq_view.bqno}">게시물수정</a> &ensp;
										<a href="/yak_erp/bq_delete?bqno=${bq_view.bqno}">게시물삭제</a>
										<p>
										</form>
