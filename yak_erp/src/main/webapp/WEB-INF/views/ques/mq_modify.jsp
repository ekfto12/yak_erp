...
<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="" class="collapse"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">일반 회원 수정</h3>
					...
					<div class="col-md-8"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">일반 회원 문의 수정</h3>
							</div>
									...
									<div class=" col-md- col-lg-12 ">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>제목:</td>
													<td><input type="text" class="form-control" id="ques_subject" name="ques_subject" value="${mq_view.ques_subject}" ></td>
													<tr>
													<td>기업명:
													<td><input type="text" class="form-control" id="member_id" name="member_id" value="${mq_view.member_id}"></td>
													</tr>
							
													<tr>
													<td>내용:</td>
													<td><textarea class="form-control" id="ques_question" name="ques_question"  rows="4" >${mq_view.ques_question}</textarea></td>
