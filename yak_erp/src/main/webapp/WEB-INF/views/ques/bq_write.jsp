									...
									<div class=" col-md- col-lg-12 ">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>제목:</td>
													<td><input type="text" class="form-control" id="subject" name="subject" placeholder="제목" default=""></td>
													<tr>
													<td>기업명:
													<td><input type="text" class="form-control" id="company_name" name="company_name" placeholder="기업명" default=""></td>
													</tr>
							
													<tr>
													<td>내용:</td>
													<td><textarea class="form-control" id="question" name="question" placeholder="문의내용" rows="4" default=""></textarea></td>
