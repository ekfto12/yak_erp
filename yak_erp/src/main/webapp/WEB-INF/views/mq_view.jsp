...
<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="" class="collapsed"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">일반 회원 문의 조회</h3>
					...
					<div class="col-md-8"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">일반 회원 문의 조회</h3>
							</div>
							...
							<form method="post" >
								<div class="row">
									...
									<div class=" col-md- col-lg-12 ">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>제목:</td>
													<td><input type="text" class="form-control" id="subject" name="ques_subject" placeholder="제목" value="${mq_view.ques_subject}" onfocus="javascrpt:blur();" style="cursor:default"></td>
													<tr>
													<td>기업명:
													<td><input type="text" class="form-control" id="member_id" name="member_id" placeholder="회원id" value="${mq_view.member_id}" onfocus="javascrpt:blur();" style="cursor:default"></td>
													</tr>
							
													<tr>
													<td>내용:</td>
													<td><textarea class="form-control" id="ques_question" name="ques_question" placeholder="문의내용" rows="4" onfocus="javascrpt:blur();" style="cursor:default">${mq_view.ques_question} </textarea></td>
									...
									<button type="submit" class="btn btn-default"
										...
										<p align=right>
										<a href="/yak_erp/mq_status?qno=${mq_view.qno}">처리완료</a> &emsp;
										<a href="/yak_erp/m_quesList?num=1" align:left;>리스트로</a> &emsp;
										<a href="/yak_erp/mq_modify?qno=${mq_view.qno}">게시물수정</a> &ensp;
										<a href="/yak_erp/mq_delete?qno=${mq_view.qno}">게시물삭제</a>
										<p>
										</form>
