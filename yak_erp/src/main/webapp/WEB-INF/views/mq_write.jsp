...
<div id="sidebar-nav" class="sidebar">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">회원 문의 등록</h3>
					...
					<div class="col-md-8"
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h3 class="panel-title">회원 문의 등록</h3>
							</div>
									...
									<div class=" col-md- col-lg-12 ">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>제목:</td>
													<td><input type="text" class="form-control" id="ques_subject" name="ques_subject" placeholder="제목" default=""></td>
													<tr>	
													<td>회원id:
													<td><input type="text" class="form-control" id="member_id" name="member_id" placeholder="회원id" default=""></td>
													</tr>
							
													<tr>
													<td>내용:</td>
													<td><textarea class="form-control" id="ques_question" name="ques_question" placeholder="문의내용" rows="4" default=""></textarea></td>
