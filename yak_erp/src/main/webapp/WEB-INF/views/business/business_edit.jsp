						...
						<div class="panel panel-info">
							...
							<div class="panel-body">
								<div class="row">
									...
									<form class="form-auth-small" action="business_update" method="post">
										<table class="table table-user-information"style="width:100%;">
											<tbody>
												<tr>
													<td>기업명:</td>
													<td><input type="text" value="${business.company_name}" name="company_name" id ="company_name" class="form-control" placeholder="company_name"></td>
													<td>대표자명:</td>
													<td><input type="text" value="${business.owner_name}" name="owner_name" id ="owner_name" class="form-control" placeholder="owner_name"></td>
												</tr>
												<tr>
													<td>기업주소:</td>
													<td><input type="text" value="${business.company_addr}" name="company_addr" id ="company_addr" class="form-control" placeholder="company_addr"></td>
													<td>비고:</td>
													<td><input type="text" value="${business.c_comment}" name="c_comment" id ="c_comment" class="form-control" placeholder="c_comment"></td>
												</tr>
												...
												<tr>
													<td>담당자ID:</td>
													<td><input type=text value="${business.manager_id}" name="manager_id" id ="manager_id" class="form-control" placeholder="manager_id"></td>
													<td>담당자PW:</td>
													<td><input type="password" value="${business.manager_pw}" name="manager_pw" id ="manager_pw" class="form-control" placeholder="manager_pw"></td>
												</tr>
												<tr>
													<td>담당자명:</td>
													<td><input type="text" value="${business.manager_name}" name="manager_name" id ="manager_name" class="form-control" placeholder="manager_name"></td>
													<td>연락처:</td>
													<td><input type="text" value="${business.contact}" name="contact" id ="contact" class="form-control" placeholder="contact"></td>
												</tr>
												<tr>
													<td>이메일:</td>
													<td><input type="email" value="${business.email}" name="email" id ="email" class="form-control" placeholder="email"></td>
												</tr>
											</tbody>
