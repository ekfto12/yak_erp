...
<body>
	...
	<form class="form-auth-small" action="drug_update" method="post">
		<div class="col-md-3">
		...
		<div class="col-md-9" style="float:right;">
				...
				<h2>약품명</h2> <input style="width:30%;" type="text" value="${drug.drug_name}" name="drug_name" id ="drug_name" class="form-control"  >
				
			<h3>
               영문명 <input style="width:30%;" type="text" value="${drug.eng_name}" name="eng_name" id ="eng_name" class="form-control"  >
            </h3>
			
			
			
            
       <p class="proile-rating">조회수 : <input style="width:10%;" type="number" value="${drug.d_hit}" name="d_hit" id ="d_hit" class="form-control"></p>
					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab_default_1">
							<div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.ingredient}" name="ingredient" id ="ingredient" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="effects" id ="effects" class="form-control" rows="4">${drug.effects}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_usage}" name="d_usage" id ="d_usage" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <textarea name="precautins" id ="precautins" class="form-control" rows="4">${drug.precautins}</textarea>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.side_effects}" name="side_effects" id ="side_effects" class="form-control"  >
                                            </div>
                                        </div>
						</div>
						...
						<div class="tab-pane" id="tab_default_4">
							<div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_route}" name="d_route" id ="d_route" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_shape}" name="d_shape" id ="d_shape" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_category}" name="d_category" id ="d_category" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_company}" name="d_company" id ="d_company" class="form-control"  >
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" value="${drug.d_code}" name="d_code" id ="d_code" class="form-control"  >
                                            </div>
                                        </div>
						</div>
					</div>
